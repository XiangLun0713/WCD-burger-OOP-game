...
class MainRecipe : Recipe
{
    ...
    public MainRecipe()
    {
        ...
        _recipe =
            $"<color={PinkColorCode}>class</color> <color={BlueColorCode}>Burger</color> {{\n    <color={PinkColorCode}>protected</color> <color={BlueColorCode}>String[]</color> patties = {{{defaultPattiesText}}};\n    <color={PinkColorCode}>protected</color> <color={BlueColorCode}>String[]</color> toppings = {{{defaultToppingsText}}};\n    <color={PinkColorCode}>protected</color> <color={BlueColorCode}>String</color> sauce = <color={YellowColorCode}>\"{_defaultSauce}\"</color>;\n}}\n\n<color={PinkColorCode}>interface</color> <color={BlueColorCode}>Patties</color> {{ <color={PinkColorCode}>void</color> <color={GreenColorCode}>setPatties</color>(<color={BlueColorCode}>String[]</color> <color={OrangeColorCode}>patties</color>); }}\n<color={PinkColorCode}>interface</color> <color={BlueColorCode}>Toppings</color> {{ <color={PinkColorCode}>void</color> <color={GreenColorCode}>setToppings</color>(<color={BlueColorCode}>String[]</color> <color={OrangeColorCode}>toppings</color>); }}\n<color={PinkColorCode}>interface</color> <color={BlueColorCode}>Sauce</color> {{ <color={PinkColorCode}>void</color> <color={GreenColorCode}>setSauce</color>(<color={BlueColorCode}>String</color> <color={OrangeColorCode}>sauce</color>); }}\n\n<color={PinkColorCode}>class</color> <color={BlueColorCode}>SuperBurger</color> <color={PinkColorCode}>extends</color> <color={BlueColorCode}>Burger</color> <color={PinkColorCode}>implements</color> <color={BlueColorCode}>Patties</color>, <color={BlueColorCode}>Toppings</color>, <color={BlueColorCode}>Sauce</color> {{\n    <color={BlueColorCode}>@Override</color>\n    <color={PinkColorCode}>public</color> <color={PinkColorCode}>void</color> <color={GreenColorCode}>setPatties</color>(<color={BlueColorCode}>String[]</color> <color={OrangeColorCode}>patties</color>) {{\n        <color={PinkColorCode}>this</color>.patties = <color={OrangeColorCode}>patties</color>;\n    }}\n\n    <color={BlueColorCode}>@Override</color>\n    <color={PinkColorCode}>public</color> <color={PinkColorCode}>void</color> <color={GreenColorCode}>setToppings</color>(<color={BlueColorCode}>String[]</color> <color={OrangeColorCode}>toppings</color>) {{\n        <color={PinkColorCode}>this</color>.toppings = <color={OrangeColorCode}>toppings</color>;\n    }}\n\n    <color={BlueColorCode}>@Override</color>\n    <color={PinkColorCode}>public</color> <color={PinkColorCode}>void</color> <color={GreenColorCode}>setSauce</color>(<color={BlueColorCode}>String</color> <color={OrangeColorCode}>sauce</color>) {{\n        <color={PinkColorCode}>this</color>.sauce = <color={OrangeColorCode}>sauce</color>;\n    }}\n}}";
    }
    ...
    public override string GenerateCustomerOrder(out HashSet<MakeBurger.BurgerContent> answerSet)
    {
        ...
        stringBuilder.Append(
            $"<color={BlueColorCode}>SuperBurger</color> burger = " +
            $"<color={PinkColorCode}>new</color> <color={GreenColorCode}>SuperBurger</color>();\n");
